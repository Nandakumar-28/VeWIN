...
export class RegisterListComponent implements OnInit {
  ...
  // showApprovalDialog: boolean = false; // Control the visibility of the approval dialog
  // showDeclinedDialog: boolean = false; // Control the visibility of the declined dialog
...
//   const ref: DynamicDialogRef = this.dialogService.open(ConfirmDeleteComponent, {
//     data: {
//       user: user
//     },
...
// }
   ...
   * @returns
   */
  confirmBlockUnBlock(userId, userName, action) {
